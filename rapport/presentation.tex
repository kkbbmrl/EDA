...
\begin{frame}{Univariate Analysis: Score Distributions}
    \begin{columns}[T]
        ...
        \begin{center}
            \includegraphics[width=0.95\textwidth]{images/math_distribution.png}
        \end{center}
        
        \column{0.46\textwidth}
        \begin{tcolorbox}[insightbox, title=Insights]
            \scriptsize
            \begin{itemize}\setlength{\itemsep}{1pt}
                \item \textbf{Math:} Mean $\approx$ 66
                \item \textbf{Reading:} Mean $\approx$ 69
                \item \textbf{Writing:} Mean $\approx$ 68
                \item Better in reading/writing
                \item Slightly left-skewed
            \end{itemize}
        \end{tcolorbox}
    \end{columns}
\end{frame}
...
\begin{frame}{Univariate Analysis: Categorical Variables}
    \begin{columns}[T]
        \column{0.52\textwidth}
        \begin{center}
            \includegraphics[width=0.95\textwidth]{images/gender_distribution.png}
        \end{center}
        
        \column{0.46\textwidth}
        \begin{tcolorbox}[insightbox, title=Distribution]
            \scriptsize
            \textbf{Gender:}
    ...
    \begin{center}
     ...
     \includegraphics[width=0.18\textwidth]{images/1736_U1RVRElPIEtBVCA0MjQtMzM.jpg}
        ...
        \begin{tcolorbox}[moderncard, title=Contact, width=0.55\textwidth]
            \centering\scriptsize
            bachir.zekhnine@univ-bba.dz\\[0.1cm]
            github.com/kkbbmrl/EDA
        \end{tcolorbox}
